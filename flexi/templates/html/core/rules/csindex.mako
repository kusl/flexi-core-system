...
<%def name="title()">System Introduction</%def>

<%def name="body()">
    <h1>The Flexi System</h1>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>Character</b> section describes the various statistics you will
    find on the character sheet, how to generate them, and what they represent.</p>
    
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>Tasks</b> section describes the game mechanics for resolving any
    tasks that the character wants to perform outside of combat..</p>
    
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>Combat</b> section describes the various game mechanics that resolve
    combat and also the consequences of it.</p>
    
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>World</b> section describes the various mechanics that involve the
    interaction of characters with their environment.</p>
    
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>Tools</b> section describes the various statisitcs for different
    equipment, as well as the game mechanics for using them.</p>
    
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The <b>Appendices</b> section consists of the term glossary, a brief outline
    of the usual character creation process and important lists.</p>
    
    <h3><b>What is the Flexi System</b></h3>
    ...
    <h3><b>How do we play the game?</b></h3>
    ...
    <h3><b>What do I do if I don't like the rules?</b></h3>
